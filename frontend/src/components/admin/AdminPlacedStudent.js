...
const AdminPlacedStudent = () => {
    ...
    return (
        <div className=' h-screen w-full'>
            ...
            <div className=" text-center mt-3 font-robotoMono text-2xl font-bold text-slate-800">Placed Students</div>
                    ...
                    <Table>
                        <TableHead>
                            ...
                            sx={{
                                ...
                                {['Job ID', 'Job Role', 'Student Name', 'USN', 'CTC', 'Company Name', 'Email'].map((cell, indx) => (
                                    <TableCell 
                                    sx={{
                                        fontSize: '18px',
                                        fontWeight: 'bold',
                        ...
                        <TableBody sx={{color: 'white'}}>
                            {postingData.map((posting) => (
                                <TableRow key={posting.appliedid}>
                                    ...
                                    <TableCell>{posting.ctc}</TableCell>
