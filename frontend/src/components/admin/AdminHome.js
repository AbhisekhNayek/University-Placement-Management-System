...
const AdminHome = () => {
    const adminLinks = [
        ...
        {
            href: '/admin/students',
            imgSrc: 'https://cdn3.vectorstock.com/i/1000x1000/24/42/student-with-laptop-computer-education-icons-vector-4382442.jpg',
            title: 'Students'
        },
        {
            href: '/admin/studentapplied',
            imgSrc: 'https://careers-in-sport.co.uk/wp-content/uploads/2017/12/killer-cv-1030x779.jpg',
            title: 'Applicants'
        },
        {
            href: '/admin/placedStudent',
            imgSrc: 'https://advisicon.com/wp-content/uploads/2020/06/Collaboration_PM-Thumbnail.png',
                    ...
                    <div className=" h-full overflow-y-auto grid place-items-center grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 lg:gap-12 pt-[8rem] pb-[4rem] ">
                        {adminLinks.map((link, indx) => (
                            <AnimatedGradientBorderTW key={indx}>
                                <Link className=' cursor-pointer bg-[#7730fc58] rounded-lg no-underline' to={`${link.href}`}>
