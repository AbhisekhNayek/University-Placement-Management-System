...
const  AdminCompany = () => {
    ...
    return (  
        <div>
            ...
            <div className=" text-center mt-3 font-robotoMono text-2xl font-bold text-slate-800">Companies Registered</div>
                        ...
                        <TableBody sx={{ color: 'black' }}>
                            {postingData?.map((posting) => (
                                <TableRow key={posting.name}>
                                    ...
                                    <TableCell>
                                        <a href={`http://${posting.website}`} target="_blank" rel="noopener noreferrer">
                                            {posting.website}
                                        </a>
                                    </TableCell>
