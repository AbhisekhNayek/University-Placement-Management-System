        ...
        <BgColorAnimation
            child={
                <div className=' w-full h-screen overflow-y-auto'>
                    ...
                    <div className=" h-full overflow-y-auto flex flex-wrap justify-center items-center gap-8 lg:gap-12 pt-[8rem] pb-[4rem] ">
                        {jobs?.map((job, indx) => (  
                                ...
                                onClick={handleViewApplicants}>
                                    <div className="rounded-lg w-[20rem] h-fit overflow-hidden shadow-lg">
                                        <div className=' w-full min-h-[20rem] max-h-[20rem]'>
                                            <img 
                                                src={'https://images.creativemarket.com/0.1.0/ps/8464561/1821/1215/m1/fpnw/wm0/bundle-coding_01-.png?1601386210&s=8cfb1a9e77a862277004fe000c837a02'} 
