    ...
    return (
        <div>
            ...
            <TableContainer component={Paper} className="container">
                <Table sx={{ minWidth: 650 }} aria-label="job selection table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell>Date of Selection</TableCell>
                    ...
                    <TableBody>
                        {data.map((row) => (
                            <TableRow key={row.jobId}>
                                ...
                                <TableCell>{row.dateOfSelection}</TableCell>
                                <TableCell>{row.selectedBy}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
